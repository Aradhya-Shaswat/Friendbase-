...
export const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {showSidebar && (
        <div className='xl:w-400 w-20 flex flex-col justify-start mb-10 border-r-2 border-gray100 xl:border-0 p-3'>
          <div className='xl:border-b-2 border-gray200 xl:pb-4'>
            <Link href="/">
          ...
          {!userProfile && (
            <div className='px-2 py-4 hidden xl:block'>
              <p className='text-gray-400'>Log into to Like and Comment on Videos.</p>
              <div className='pr-4'>
                <GoogleLogin 
                  clientId=''
                  render={(renderProps) => (
